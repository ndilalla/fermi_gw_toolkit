...
CMD="python ${FERMI_GWTOOLS}/bin/get_coverage.py --in_map $HEALPIX_PATH_MAP --ft2 $OUTPUT_FILE_PATH/$TRIGGERNAME/gll_ft2_tr_${TRIGGERNAME}_v00.fit --start_time ${MET_TSTART} --stop_time ${MET_TSTOP} --theta_cut $THETAMAX --zenith_cut $ZMAX --outroot $OUTCOV"
echo $CMD
$CMD
