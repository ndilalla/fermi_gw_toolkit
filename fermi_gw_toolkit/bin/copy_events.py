...
def copy_events(**kwargs):
    ...
    if done_dir is not None:
        ...
        for file_path in files:
            ...
            db_update = copy_event(name, db_dict, version, overwrite=True, send_alert=send_alert) or db_update
    ...
    if db_update is True:
        ...
        db_dict.save(db_file, chmod=True)
        _copy(db_file, stanford_dir + db_dict.obs_run + '/')
    else:
        db_dict.release_lock(chmod=True)
    print('Done!')
