...
"""
def adaptive():
    from fermi_gw_toolkit.AdaptiveTimeIntervals import Adaptive
    Adaptive(healpix_map=LIGO_MAP, ft2=ft2, triggertime=TRIGGERTIME, 
             theta_max=THETAMAX, zenith_max=ZMAX, 
             degrade=32, 
             output='adaptive_time_intervals_times.txt', plot=1, orgx=0, orgy=0)
